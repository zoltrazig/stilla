...
//! call elimination, 8.3 partial redundancy elimination, 8.5 dead block
//! elimination, 8.6 drop elision, 8.8 jump threading, 8.7 phi
//! simplification. The sequence runs as a single ordered pass — no
