...
pub fn internType(bld: *Builder, t: cfg.Type) error{OutOfMemory}!llir.TypeId {
    ...
    switch (t) {
        .primitive => |k| switch (k) {
            ...
            .int64 => desc = .{ .kind = .primitive, .a = @intFromEnum(llir.PrimitiveId.int64), .b = 0, .c = 0 },
            .uint64 => desc = .{ .kind = .primitive, .a = @intFromEnum(llir.PrimitiveId.uint64), .b = 0, .c = 0 },
            .float32 => desc = .{ .kind = .primitive, .a = @intFromEnum(llir.PrimitiveId.float32), .b = 0, .c = 0 },
            .float64 => desc = .{ .kind = .primitive, .a = @intFromEnum(llir.PrimitiveId.float64), .b = 0, .c = 0 },
