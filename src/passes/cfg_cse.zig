...
//! anywhere else, air.md §5.6), so a slot's value is stable for the life
...
//! the destruction schedule (air.md §6.4).
//!
...
//! afterwards (air.md §13). Allocations use the program's backing
